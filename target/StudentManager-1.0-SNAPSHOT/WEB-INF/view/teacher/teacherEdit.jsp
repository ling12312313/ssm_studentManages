		...
		<div class="layui-row layui-col-space10">
			<div class="layui-col-md9 layui-col-xs7">
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" id="edit_name" name="name" class="layui-input newsName" lay-verify="newsName" placeholder="请输入文章标题">
					</div>
				</div>
				<div class="layui-form-item magt3">
				...
				<div class="layui-form-item magt3">
					<label class="layui-form-label">所受班级</label>
					<div class="layui-input-block">
 ...
 */	        //弹出loading
	        ...
	        // })
	        	$.ajax({
					type: "post",
					url: "/TeacherServlet/EditTeacher",

		...
		<div class="layui-row layui-col-space10">
			<div class="layui-col-md9 layui-col-xs7">
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" id="edit_name" name="name" class="layui-input edit_name" lay-verify="editName" placeholder="请输入课程名字">
					</div>
				</div>
				<div class="layui-form-item magt3">
					<label class="layui-form-label">上课时间</label>
					<div class="layui-input-block">
						<input type="text" id="edit_date" name="course_date" class="layui-input course_date" lay-verify="course_date" placeholder="请输入上课时间">
					</div>
				</div>
				<div class="layui-form-item magt3">
					<label class="layui-form-label">最多可选人数</label>
					<div class="layui-input-block">
						<input type="text" id="edit_maxnum" name="maxnum" class="layui-input maxnum" lay-verify="maxnum" placeholder="请输入最多可选人数">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">课程简介</label>
					<div class="layui-input-block">
						<textarea id="edit_info" placeholder="请输入课程简介"  name="info" class="layui-textarea info"></textarea>
					</div>
				</div>
				<div class="layui-form-item magt3">

 ...
 -->		<!-- <div class="layui-row layui-col-space10"> -->
			<div class="layui-col-md9 layui-col-xs7">
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" id="add_mobile" name="mobile" class="layui-input add_mobile"  placeholder="请输入电话">
					</div>
				</div>
				<div class="layui-form-item magt3">
					<label class="layui-form-label">QQ</label>
					<div class="layui-input-block">
						<input type="text" id="add_qq" name="qq" class="layui-input add_qq"  placeholder="请输入qq">
					</div>
				</div>
				<div class="layui-form-item magt3">

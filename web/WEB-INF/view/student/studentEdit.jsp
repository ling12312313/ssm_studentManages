			...
			<div class="layui-col-md9 layui-col-xs7">
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" id="edit_ID" readonly="readonly" name="id" class="layui-input newsID"  >
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" id="edit_name" name="name" class="layui-input newsName" lay-verify="newsName" placeholder="请输入学生名称">
					</div>
				</div>
				</c:if>
				...
				<div class="layui-form-item magt3">
					<label class="layui-form-label">学生名称</label>
					<div class="layui-input-block">
						<input type="text" id="edit_name" readonly="readonly" name="name" class="layui-input newsName" lay-verify="newsName" placeholder="请输入学生名称">
					</div>
				</div>
				</c:if>
				<div class="layui-form-item magt3">
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" id="edit_mobile" name="mobile" class="layui-input edit_mobile"  placeholder="请输入电话">
					</div>
				</div>
				<div class="layui-form-item magt3">
					<label class="layui-form-label">QQ</label>
					<div class="layui-input-block">
						<input type="text" id="edit_qq" name="qq" class="layui-input edit_qq"  placeholder="请输入qq">
					</div>
				</div>
 ...
 */	        //弹出loading
	        ...
	        // })
	        	$.ajax({
					type: "post",
					url: "/StudentServlet/EditStudent",
					//data: $("#editForm").serialize(), 
					data:form.val("formTest"),
					success: function(msg){
					if(msg == "success"){
						top.layer.msg("学生修改成功！");		
						} else{
							 top.layer.msg("学生修改失败！");		
							 return;
								}
						}
				});
